            ...
            <div className="w-full mx-auto max-w-xs">
                <form onSubmit={handleSignin} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <div className='flex justify-center mt-3 pl-5'>
                        <Link to="/signup">
                            <p className='font-bold text-md mt-2 mr-4 text-blue-700 hover:text-blue-500 cursor-pointer'>New to LIVISA? </p>
                        </Link>
                    </div>
                ...
                <div className='flex justify-center ml-5 margin-top'>
                    ...
                    <button onClick={forgetPassword} className="font-bold text-md mr-4 text-blue-700 hover:text-blue-500 cursor-pointer">Forget Password</button>
                </div>
